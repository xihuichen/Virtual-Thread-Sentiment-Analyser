...
public enum ConsoleColour {
	...
	ConsoleColour(String description, String colour) {
		/**
		 * @param String description: the description of color, example:"Cyan [High
		 *               Intensity BG]" String color: e.g. "0;106"
		 * 
		 * @return return the pre-specified enums
		 * 
		 *         Complexity: O(1) Rationale: assigns string value, constant time
		 *         operation
		 */
	...
	public String description() {
		/**
		 * Takes no params input and returns the description of the class Complexity:
		 * O(1) Rationale: returns string value, constant time operation
		 */
	...
	public String colour() {
		/**
		 * Takes no params input and returns the string value of colour name Complexity:
		 * O(1) Rationale: returns string value, constant time operation
		 */
		return toString();
	}
	...
	public String toString() {
		...
		/**
		 * Overriden the toString method. Takes no params input returns the
		 * CTRL_SEQ_INTRO and the color of this instance and CTRL_SEQ_END Complexity:
		 * O(1) Rationale: returns string value, constant time operation
		 */
